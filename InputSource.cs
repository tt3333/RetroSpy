...
namespace RetroSpy
{
    public class InputSource
    {
        ...
        public static readonly InputSource EVERCADE = new InputSource("evercade", "Blaze Evercade Vs", false, false, true, false, false, (hostname, username, password) => new SSHControllerReader(hostname, "sudo pkill -9 usb-mitm ; sudo usb-mitm 2> /dev/null -n", EVS.ReadFromPacket, username, password, null, 0));
        ...
        public static readonly InputSource TG16 = new InputSource("tg16", "NEC TurboGrafx-16", true, false, false, false, false, (port, useLagFix) => new SerialControllerReader(port, useLagFix, Tg16.ReadFromPacket));
        public static readonly InputSource PCFX = new InputSource("pcfx", "NEC PC-FX", true, false, false, false, false, (port, useLagFix) => new SerialControllerReader(port, useLagFix, SuperNESandNES.ReadFromPacketPCFX));
        public static readonly InputSource TG16MINI = new InputSource("tg16mini", "NEC TurboGrafx-16 Mini", false, false, true, false, false, (hostname, username, password) => new SSHControllerReader(hostname, "sudo pkill -9 usb-mitm ; sudo usb-mitm 2> /dev/null -j", Tg16Mini.ReadFromPacket, username, password, null, 0));
        ...
        public static readonly InputSource GENMINI = new InputSource("genesismini", "Sega Genesis Mini", false, false, true, false, false, (hostname, username, password) => new SSHControllerReader(hostname, "sudo pkill -9 usb-mitm ; sudo usb-mitm 2> /dev/null -z", GenesisMiniReader.ReadFromPacket, username, password, null, 0));
        ...
        public static readonly InputSource PS4CRONUS = new InputSource("playstation4", "Sony PlayStation 4 via Cronus Zen", false, false, true, false, false, (hostname, username, password) => new SSHControllerReader(hostname, "sudo pkill -9 usb-mitm ; sleep 1 ; sudo usb-mitm 2> /dev/null -q", PS4Reader.ReadFromPacket, username, password, null, 0));
