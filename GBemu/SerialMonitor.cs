    ...
    public class SerialMonitor : IDisposable
    {
        ...
        private void Tick(object sender, EventArgs e)
        {
            ...
            if (_printerMode)
            {
                ...
                if (lastCommand.Contains("# Finished Pretending To Print for fun!") || lastCommand.Contains("// Timed Out (Memory Waterline: 4B out of 400B)") ||  lastCommand.Contains("// Timed Out (Memory Waterline: 6B out of 400B)"))
                {
