...
Wii用のケーブルとスーパーファミコン用のケーブルの両方を実装する場合、Bottom_for_two_controllers.stlとTop_with_switch.stlをプリントしてください。<BR>
...
8. 「Tools」→「CPU Speed」→「250 MHz (Overclock)」をクリック
9. 「Tools」→「Optimize」→「Optimize Even More (-O3)」をクリック
