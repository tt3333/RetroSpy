...
#define SMSONG_INPUT_PIN_0    DIGITAL_PIN_02
#define SMSONG_INPUT_PIN_1    DIGITAL_PIN_03
#define SMSONG_INPUT_PIN_2    DIGITAL_PIN_04
#define SMSONG_INPUT_PIN_3    DIGITAL_PIN_05
