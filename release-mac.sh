...
/usr/local/share/dotnet/dotnet publish RetroSpyX/RetroSpyX.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-x64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/RetroSpy bin/Release/net8.0/publish/RetroSpy-x64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
/usr/local/share/dotnet/dotnet publish RetroSpyX/RetroSpyX.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-arm64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/RetroSpy bin/Release/net8.0/publish/RetroSpy-arm64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64
lipo -create -output bin/Release/net8.0/publish/RetroSpy bin/Release/net8.0/publish/RetroSpy-arm64 bin/Release/net8.0/publish/RetroSpy-x64
lipo -create -output bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64 bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
rm bin/Release/net8.0/publish/*-arm64
rm bin/Release/net8.0/publish/*-x64
...
cp -aR bin/Release/net8.0/publish/* bin/Release/RetroSpy-macOS/RetroSpy.app/Contents/MacOS
...
mv bin/Release/RetroSpy-macOS/RetroSpy.app/Contents/MacOS/vjoybindings.xml bin/Release/RetroSpy-macOS/
cp -aR bin/Release/net8.0/firmware bin/Release/RetroSpy-macOS/firmware
...
rm -rf bin/Release/net8.0
/usr/local/share/dotnet/dotnet publish GBPemuX/GBPemuX.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-x64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/GBPemu bin/Release/net8.0/publish/GBPemu-x64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
/usr/local/share/dotnet/dotnet publish GBPemuX/GBPemuX.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-arm64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/GBPemu bin/Release/net8.0/publish/GBPemu-arm64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64
lipo -create -output bin/Release/net8.0/publish/GBPemu bin/Release/net8.0/publish/GBPemu-arm64 bin/Release/net8.0/publish/GBPemu-x64
lipo -create -output bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64 bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
rm bin/Release/net8.0/publish/*-arm64
rm bin/Release/net8.0/publish/*-x64
...
cp -aR bin/Release/net8.0/publish/* "bin/Release/RetroSpy-macOS/RetroSpy Pixel Viewer.app/Contents/MacOS"
mv "bin/Release/RetroSpy-macOS/RetroSpy Pixel Viewer.app/Contents/MacOS/game_palettes.cfg" bin/Release/RetroSpy-macOS/

rm -rf bin/Release/net8.0
/usr/local/share/dotnet/dotnet publish GBPUpdaterX2/GBPUpdaterX2.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-x64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/GBPUpdater bin/Release/net8.0/publish/GBPUpdater-x64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
/usr/local/share/dotnet/dotnet publish GBPUpdaterX2/GBPUpdaterX2.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-arm64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/GBPUpdater bin/Release/net8.0/publish/GBPUpdater-arm64
mv bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64
lipo -create -output bin/Release/net8.0/publish/GBPUpdater bin/Release/net8.0/publish/GBPUpdater-arm64 bin/Release/net8.0/publish/GBPUpdater-x64
lipo -create -output bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-arm64 bin/Release/net8.0/publish/libSystem.IO.Ports.Native.dylib-x64
rm bin/Release/net8.0/publish/*-arm64
rm bin/Release/net8.0/publish/*-x64
...
cp -aR bin/Release/net8.0/publish/* "bin/Release/RetroSpy-macOS/RetroSpy Pixel Updater.app/Contents/MacOS"

rm -rf bin/Release/net8.0
/usr/local/share/dotnet/dotnet publish UsbUpdaterX2/UsbUpdaterX2.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-x64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/UsbUpdater bin/Release/net8.0/publish/UsbUpdater-x64
/usr/local/share/dotnet/dotnet publish UsbUpdaterX2/UsbUpdaterX2.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ /p:RuntimeIdentifier=osx-arm64 /p:SelfContained=true -p:PublishSingleFile=true -p:UseAppHost=true
mv bin/Release/net8.0/publish/UsbUpdater bin/Release/net8.0/publish/UsbUpdater-arm64
lipo -create -output bin/Release/net8.0/publish/UsbUpdater bin/Release/net8.0/publish/UsbUpdater-arm64 bin/Release/net8.0/publish/UsbUpdater-x64
rm bin/Release/net8.0/publish/*-arm64
rm bin/Release/net8.0/publish/*-x64
...
cp -aR bin/Release/net8.0/publish/* "bin/Release/RetroSpy-macOS/RetroSpy Vision USB Updater.app/Contents/MacOS"
