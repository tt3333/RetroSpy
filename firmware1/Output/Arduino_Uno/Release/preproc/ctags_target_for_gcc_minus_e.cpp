...
# 221 "E:\\src\\Repos\\RetroSpy\\firmware\\sketches\\firmware.ino" 3
   (*(volatile uint8_t *)((0x08) + 0x20)) 
# 221 "E:\\src\\Repos\\RetroSpy\\firmware\\sketches\\firmware.ino"
         = 0xFF; // Set the pull-ups on the port we use to check operation mode.
    
# 222 "E:\\src\\Repos\\RetroSpy\\firmware\\sketches\\firmware.ino" 3
   (*(volatile uint8_t *)((0x07) + 0x20)) 
# 222 "E:\\src\\Repos\\RetroSpy\\firmware\\sketches\\firmware.ino"
         = 0x00;
